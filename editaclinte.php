...
<head>
    ...
    <link rel="stylesheet" href="modeloeditar.css">
...
<div class='container'>
    ...
    <form method="post" class="container" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col">
                <input type="date" class="form-control" placeholder="Observação" name="obs" value="<?php echo $linha['obs'] ?>" />
            </div>
            <div class="col">
                <input type="file" class="form-control" placeholder="Informe o CNPJ" name="cnpj" value="<?php echo $linha['cnpj'] ?>" />
            </div>
        </div><br><br>
